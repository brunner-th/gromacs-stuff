...
with open('Nanotube_1nm.xmol') as f:
...
cnt_x += 0 #+ reservoir_width/2
cnt_y += 0 #+ reservoir_width/2
cnt_z += reservoir_height #+ cnt_lenght
...
for idz, z in enumerate(cnt_x):
    if (cnt_x[idz]-2.5)**2 + (cnt_y[idz]-2.5)**2 <= radius**2:
